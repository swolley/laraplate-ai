...
return new class extends Migration
{
    ...
    {
        $table_name = AITables::Messages->value;
        Schema::create($table_name, static function (Blueprint $table) use ($table_name): void {
             ...
             */
            $table->index(['conversation_id', 'created_at'], "{$table_name}_conversation_created_IDX");
        });
    }
    ...
    {
        Schema::dropIfExists(AITables::Messages->value);
    }
};
